...
@section('Content')   
        <div class="container px-6 mx-auto grid">
            ...
            <h4
              ...
              Edit Table Bank Soal
            </h4>

            <form action="{{route('bank_soal.update',$table->id)}}" method="POST">
              @method('PUT')
              @csrf
              <div
