...
@section('Content')   
        <div class="container px-6 mx-auto grid">
            ...
            <h4
              ...
              Edit Table Peraturan
            </h4>

            <form action="{{route('peraturan.update',$table->id)}}" method="POST">
              @method('PUT')
              @csrf
              <div
                ...
                <label class="block text-sm">
                  ...
                  <input
                    ...
                    value="{{$table->no_peraturan}}" name="no_peraturan"/>
                </label>
                ...
                <label class="block text-sm">
                  ...
                  <input
                    class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                    value="{{$table->tentang}}" name="tentang"/>
                </label>
                ...
                <label class="block text-sm">
                  ...
                  <input
                    class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                    value="{{$table->tgl_ditetapkan}}" name="tgl_ditetapkan"/>
                </label>
                ...
                <label class="block text-sm">
                  ...
                  <input
                    class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                    value="{{$table->tgl_diundangkan}}" name="tgl_diundangkan"/>
                </label>
