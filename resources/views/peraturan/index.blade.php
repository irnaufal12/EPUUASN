                ...
                <table class="w-full whitespace-no-wrap">
                  <thead>
                    <tr
                      ...
                      <th class="px-4 py-3">No Peraturan</th>
                      <th class="px-4 py-3">Tentang</th>
                      <th class="px-4 py-3">Tanggal Ditetapkan</th>
                      <th class="px-4 py-3">Tanggal Diundangkan</th>
                    ...
                    <tr class="text-gray-700 dark:text-gray-400">
                      ...
                      <td class="px-4 py-3">
                        <div class="flex items-center space-x-4 text-sm">
                          ...
                          {{-- ACTION (EDIT) --}}
                          <a href="{{route('peraturan.edit',$data->id)}}">
                          <button
                          ...
                          {{-- ACTION (DELETE) --}}
                          <a href="{{route('peraturan.delete',$data->id)}}">
                          <button
                            class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray"
                            aria-label="Delete">
                            <svg
